 ...
 * quit. If "y", then prompt user for a positive double. Uses the Newton
 * Iteration method for finding the square root. Works when x = 0.
 *
...
public final class Newton2 {
    ...
    private static double sqrt(double x) {
        double r = x;
        final double setEPSILON = 0.0001; //guidelines give max error as 0.01%
